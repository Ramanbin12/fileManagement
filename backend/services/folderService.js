const {createFolder,getFolders,deleteFolder}=require("../dblayer/folderquery")
...
const getFolderService=async(req,res)=>{
    ...
    console.log("nnnnnnnnnnnnnnnnn",id)
...
module.exports={insertFolderService,getFolderService,deleteFolderService}